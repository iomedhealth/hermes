...
This document outlines the extraction and linkage logic for Healthcare Resource Utilization (HCRU) and direct medical expenditures from the OMOP CDM `COST` table across the HERMES ecosystem.
