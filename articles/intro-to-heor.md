...
**omopHeor** bridges the gap between the OMOP world and **Health
Economics and Outcomes Research (HEOR)**. This guide will help translate
the concepts you already know into the framework of Cost-Effectiveness
Analysis (CEA).
...
plots, omopHeor enforces a strict 6-stage pipeline:
...
omopHeor profiles the cohorts, extracting demographics and calculating
...
omopHeor tracks how patients transition between different health states
...
Stage 4, omopHeor simulates a decision-analytic Markov model. This
...
Finally, omopHeor calculates the ICER and Net Monetary Benefit (NMB),
