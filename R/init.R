...
#'
#' @description
#' `init()` is the entry point for the HERMES 6-stage pipeline. It takes an existing
...
#'
#' @return A `hermes_study` S3 object containing the CDM reference and cohort metadata,
